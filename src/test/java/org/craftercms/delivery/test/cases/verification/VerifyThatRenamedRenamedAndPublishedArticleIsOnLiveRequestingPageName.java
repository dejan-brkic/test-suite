...
public class VerifyThatRenamedRenamedAndPublishedArticleIsOnLiveRequestingPageName extends DeliveryBaseTest {
	...
	public void verifyThatRenamedAndPublishedArticleIsOnLiveRequestingPageHTML() {
		...
		Assert.assertTrue(this.driverManager.getDriver().getCurrentUrl()
				.equalsIgnoreCase("http://localhost:9080/articles/2016/12/baz"));
	}
