 ...
 *
 */
//Test Case Studio- Site Dropdown ID:20
public class VerifyRightClickOptionsOfAnEditedAndRequestPublishPageUnderPageStructureUsingAdminUser
	...
	private static Logger logger = LogManager.getLogger(
			VerifyRightClickOptionsOfAnEditedAndRequestPublishPageUnderPageStructureUsingAdminUser.class);
	...
	public void expandHomeTree() {
		this.getWebDriverManager().waitUntilSidebarOpens();
		this.getWebDriverManager().waitForAnimation();
		getWebDriverManager().clickElement("xpath", homePageEditedExpand);
	}
	...
	@Test()
	public void verifyRightClickOptionsOfAnEditedAndRequestPublishPageUnderPageStructureUsingAdminUser(
