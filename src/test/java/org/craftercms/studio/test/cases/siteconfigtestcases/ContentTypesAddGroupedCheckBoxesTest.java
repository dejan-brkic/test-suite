...
public class ContentTypesAddGroupedCheckBoxesTest  extends StudioBaseTest{
	...
	public void dragAndDrop() {
		...
		WebElement FromGroupedCheckBoxes = this.getWebDriverManager().driverWaitUntilElementIsPresentAndDisplayed( "xpath",
	...
	@Parameters({"testId"})
	@Test()
	public void verifyThatStudioAllowsToAddAGroupedCheckBoxesControlToExistingContentTypeTest(String testId) {
