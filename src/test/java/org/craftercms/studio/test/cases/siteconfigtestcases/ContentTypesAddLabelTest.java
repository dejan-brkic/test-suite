...
public class ContentTypesAddLabelTest  extends StudioBaseTest{
	...
	public void dragAndDrop() {
		...
		this.getWebDriverManager().focusAndScrollDownToMiddleInASection("#widgets-container",lastControlElementCssSelector, 15);
		WebElement FromLabel = this.getWebDriverManager().driverWaitUntilElementIsPresentAndDisplayed( "xpath",
