...
public class ContentTypesAddItemSelectorTest extends StudioBaseTest{
	...
	public void dragAndDrop() {
		...
		WebElement FromItemSelector = this.getWebDriverManager().driverWaitUntilElementIsPresentAndDisplayed( "xpath",
	...
	@Parameters({"testId"})
	@Test()
	public void verifyThatStudioAllowsToAddAnItemSelectorControlToExistingContentTypeTest(String testId) {
