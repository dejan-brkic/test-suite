 ...
 *
 */
public class ListRemotesAPI2Test {
    ...
    private String siteId = "listremoteapi2test";

    public ListRemotesAPI2Test() {
    ...
    public void testListRemote() {
        repositoryAPI2.testListRemote(siteId, "originbasic", gitRepoUrl, "origintoken",
                gitRepoUrl, "originkey", gitRepoUrlSsh);
    }
    ...
    @AfterGroups(groups = {"ListRemoteAPI2"})
    public void afterTest() {
        siteManagementAPI.testDeleteSite(siteId);
        securityAPI.logOutFromStudioUsingAPICall();
    }

    @Test(dependsOnGroups = {"ListRemoteAPI2"})
    public void testListRemoteUnauthorized() {
        repositoryAPI2.testListRemoteUnAuthorized(siteId);
    }
}