...
import org.craftercms.studio.test.api2.objects.UIManagementAPI2;
...
public class GetViewsGlobalMenuItemsForCurrentUserAPI2Test {

	private SecurityAPI securityAPI;
	private UIManagementAPI2 uiManagementAPI2;

	public GetViewsGlobalMenuItemsForCurrentUserAPI2Test() {
		APIConnectionManager apiConnectionManager = new APIConnectionManager();
		JsonTester api = new JsonTester(apiConnectionManager.getProtocol(), apiConnectionManager.getHost(),
				apiConnectionManager.getPort());
		securityAPI = new SecurityAPI(api, apiConnectionManager);
		uiManagementAPI2 = new UIManagementAPI2(api, apiConnectionManager);
	}
