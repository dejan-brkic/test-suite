...
public class GetUserAPI2Test {
	...
	public void testGetUser() {
		usersManagementAPI2.testGetUserById(userId);
	}
	...
	public void testGetUserNotFound() {
		usersManagementAPI2.testGetUserByIdNotFound(userId);
	}
	...
	public void testGetUserBadRequest() {
		usersManagementAPI2.testGetUserByIdBadRequest(userId);
	}
	...
	@Test(
			dependsOnGroups = { "getUserAPI2" })
	public void testGetUserUnauthorized() {
		usersManagementAPI2.testGetUserByIdUnauthorized(userId);
	}
}
