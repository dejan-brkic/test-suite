 ...
 *
 */
public class ContentTypesAddRepeatingGroupTest extends StudioBaseTest{
	...
	@Parameters({"testId"})
	@Test()
	public void verifyThatStudioAllowsToAddARepeatingGroupControlToExistingContentTypeTest(String testId) {
